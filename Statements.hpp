...
// how to handle two types of assignment statements?
class AssignmentStatement : public Statement {
public:

    AssignmentStatement();
    AssignmentStatement(std::string lhsVar, ExprNode *rhsExpr);
    //AssignmentStatement(std::string lhsVar, std::vector<ExprNode*> rhsExprVect);
    ...
    void setVariableAssign(bool f)  {isVariableAssign = f;}
    void setArrayInit(bool f)      {isArrayInit = f;}
...
private:
    ...
    std::vector<ExprNode*> _rhsExprVect;
    bool isVariableAssign;
    bool isArrayInit;
};
...
public:
    ...
    ArrayOperationStatement(std::string, std::string, ExprNode* = nullptr);
