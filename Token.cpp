...
Token::Token(): _name{""}, _eof{false}, _eol{false}, _symbol{'\0'}, _isinteger{false},
    _isBoolean{false}, _isString{false}, _isFuncName{false}, _isArrayName{false}, _isArrayOp{false}, _stringSymbol{""}, _isIndent(false), _isDedent(false) {}
...
void Token::print() const {
    ...
    else if( isOpenSquareBrackets() ) std::cout << "[";
    else if( isClosedSquareBrackets() ) std::cout << "]";
