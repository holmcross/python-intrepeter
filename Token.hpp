...
public:
    ...
    bool isOpenSquareBrackets() const     { return _symbol == '['; }
    bool isClosedSquareBrackets() const   { return _symbol == ']'; }
    ...
    bool isArrayAppend() const      { return _name == "append"; }
    bool isArrayPop() const         { return _name == "pop"; }

    bool isArrayOperation() const {
        return  isArrayAppend() ||
                isArrayPop();
    }
    ...
    bool &isArrayName()             { return _isArrayName;}
    bool isArrayName()  const       { return _isArrayName;}
